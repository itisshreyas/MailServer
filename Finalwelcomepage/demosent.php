...
<body style="background:#394264;">
  ...
  <div class="top_menu_list">
    <div class="list">
    <ul class="hor_menu">
      <li class="menu_bar"><input  type="button" onclick="window.location.href='http://localhost:8080/OST/Finalwelcomepage/index.php'" class="menu_buttons" id="back_to_home"/></li>
